...
> This file is the single source of truth for coding-agent instructions in this
> repo. `CLAUDE.md`, `GEMINI.md` and `.github/copilot-instructions.md` are
> symlinks to it — edit `AGENTS.md` only.
