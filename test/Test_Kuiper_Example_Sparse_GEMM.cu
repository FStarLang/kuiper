...
int main(int argc, char **argv)
{
    ...
    cudaMemcpy(
        dA.elems, A.elems, sizeof A.elems[0] * A.nnz, cudaMemcpyHostToDevice);
    cudaMemcpy(dA.col_ind, A.col_ind, sizeof A.col_ind[0] * A.nnz,
        cudaMemcpyHostToDevice);
    cudaMemcpy(dA.row_off, A.row_off, sizeof A.row_off[0] * (N + 1),
        cudaMemcpyHostToDevice);
