...
int main()
{
    ...
    MUST(cudaMemcpy(a, a_cpu, DIM * DIM * sizeof(float),
                    cudaMemcpyHostToDevice));
    MUST(cudaMemcpy(b, b_cpu, DIM * DIM * sizeof(float),
                    cudaMemcpyHostToDevice));
    MUST(cudaMemcpy(c, c_cpu, DIM * DIM * sizeof(float),
                    cudaMemcpyHostToDevice));
    MUST(cudaMemcpy(d, d_cpu, DIM * DIM * sizeof(float),
                    cudaMemcpyHostToDevice));
