...
static void check_f32(const char *name, float got, float expected, float tol)
{
    ...
    int ok = (err <= tol) || (isnan(got) && isnan(expected)) || (isinf(got) && isinf(expected) && got == expected);
    if (ok) {
        n_pass++;
    } else {
...
static void check_f16(const char *name, half got, float expected, float tol)
{
    ...
    int ok = (err <= tol) || (isnan(g) && isnan(expected)) || (isinf(g) && isinf(expected) && g == expected);
    if (ok) {
        n_pass++;
    } else {
...
int main()
{
    ...
    check_f32("atan2",    Kuiper_Example_MathPrimitives_test_atan2_f32(x32, y32),    atan2f(x32, y32),    tol32);
    check_f32("fmin",     Kuiper_Example_MathPrimitives_test_fmin_f32(x32, y32),     fminf(x32, y32),     tol32);
    check_f32("fmax",     Kuiper_Example_MathPrimitives_test_fmax_f32(x32, y32),     fmaxf(x32, y32),     tol32);
    check_f32("fmod",     Kuiper_Example_MathPrimitives_test_fmod_f32(y32, x32),     fmodf(y32, x32),     tol32);
    check_f32("copysign", Kuiper_Example_MathPrimitives_test_copysign_f32(x32, -y32), copysignf(x32, -y32), tol32);

    /* ternary */
    check_f32("fma",      Kuiper_Example_MathPrimitives_test_fma_f32(x32, y32, z32), fmaf(x32, y32, z32), tol32);
    ...
    check_f64("atan2",    Kuiper_Example_MathPrimitives_test_atan2_f64(x64, y64),    atan2(x64, y64),    tol64);
    ...
    check_f64("copysign", Kuiper_Example_MathPrimitives_test_copysign_f64(x64, -y64), copysign(x64, -y64), tol64);
    check_f64("fma",      Kuiper_Example_MathPrimitives_test_fma_f64(x64, y64, z64), fma(x64, y64, z64), tol64);
    ...
    check_f16("rsqrt",    Kuiper_Example_MathPrimitives_test_rsqrt_f16(x16),  1.0f/sqrtf(0.5f), tol16);
    ...
    check_f16("fabs",     Kuiper_Example_MathPrimitives_test_fabs_f16(__hneg(x16)), fabsf(0.5f), tol16);
    ...
    check_f16("atan2",    Kuiper_Example_MathPrimitives_test_atan2_f16(x16, y16),    atan2f(0.5f, 2.0f),    tol16);
    check_f16("fmin",     Kuiper_Example_MathPrimitives_test_fmin_f16(x16, y16),     fminf(0.5f, 2.0f),     tol16);
    check_f16("fmax",     Kuiper_Example_MathPrimitives_test_fmax_f16(x16, y16),     fmaxf(0.5f, 2.0f),     tol16);
    check_f16("fmod",     Kuiper_Example_MathPrimitives_test_fmod_f16(y16, x16),     fmodf(2.0f, 0.5f),     tol16);
    check_f16("copysign", Kuiper_Example_MathPrimitives_test_copysign_f16(x16, __hneg(y16)), copysignf(0.5f, -2.0f), tol16);
    check_f16("fma",      Kuiper_Example_MathPrimitives_test_fma_f16(x16, y16, z16), fmaf(0.5f, 2.0f, 3.0f), tol16);
