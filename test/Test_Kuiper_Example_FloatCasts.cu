...
int main()
{
    ...
    /* from f16 */
    check("f16->f16",
          __half2float(Kuiper_Example_FloatCasts_test_cast_f16_f16(xh)),
          __half2float(xh), 0.0);
    check("f16->f32", Kuiper_Example_FloatCasts_test_cast_f16_f32(xh),
          __half2float(xh), 0.0);
    ...
    /* from f32 */
    check("f32->f16",
          __half2float(Kuiper_Example_FloatCasts_test_cast_f32_f16(xf)),
          __half2float(__float2half_rn(xf)), 0.0);
    check("f32->f32", Kuiper_Example_FloatCasts_test_cast_f32_f32(xf),
          (double) xf, 0.0);
    check("f32->f64", Kuiper_Example_FloatCasts_test_cast_f32_f64(xf),
          (double) xf, 0.0);

    /* from f64 */
    check("f64->f16",
          __half2float(Kuiper_Example_FloatCasts_test_cast_f64_f16(xd)),
          __half2float(__float2half_rn((float) xd)), 0.0);
    check("f64->f32", Kuiper_Example_FloatCasts_test_cast_f64_f32(xd),
          (double) (float) xd, 0.0);
