...
__global__ __launch_bounds__(1) static void kuiper_kernel_0(uint64_t *r1);
__global__ __launch_bounds__(1) static void kuiper_kernel_1(uint64_t *r2);
__global__ __launch_bounds__(1) static void kuiper_kernel_2(uint64_t *r3);
__global__ __launch_bounds__(1) static void kuiper_kernel_3(uint64_t *r4);
__global__ __launch_bounds__(1) static void kuiper_kernel_4(uint64_t *r5);
__global__ __launch_bounds__(1) static void kuiper_kernel_5(uint64_t *r6);
