/* 
  ...
  KaRaMeL invocation: /home/guido/r/kuiper/main/karamel/krml -add-early-include <kuiper.h> -fc++-compat -fcast-allocations -skip-compilation -skip-makefiles -cuda -silent -drop Prims -minimal -warn-error -2@4-10@18 -bundle Kuiper.HReduceF64Plus=* -tmpdir obj obj/Kuiper_HReduceF64Plus.krml
  F* version: <unknown>
