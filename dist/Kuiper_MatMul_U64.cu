...
uint64_t
*Kuiper_MatMul_U64_matmul_u64_ccr(
  size_t rows,
  size_t shared,
  size_t cols,
  uint64_t *a,
...
uint64_t
*Kuiper_MatMul_U64_matmul_u64_rrc(
  size_t rows,
  size_t shared,
  size_t cols,
  uint64_t *a,
