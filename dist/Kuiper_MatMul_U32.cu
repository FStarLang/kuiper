...
uint32_t
*Kuiper_MatMul_U32_matmul_u32__(
  size_t rows,
  size_t shared,
  size_t cols,
  uint32_t *a,
...
)
{
  ...
  gC[rows * cols - (size_t)1U - trow * cols - tcol] = sum;
}

uint32_t
*Kuiper_MatMul_U32_matmul_u32_mirror(
  size_t rows,
  size_t shared,
  size_t cols,
  uint32_t *a,
