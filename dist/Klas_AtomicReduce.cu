...
Klas_AtomicReduce_reduce_u32_kernel_0(uint32_t *a, uint32_t *gr);
__global__ __launch_bounds__(1) static void
Klas_AtomicReduce_reduce_u64_kernel_1(uint64_t *a, uint64_t *gr);
__global__ __launch_bounds__(1) static void
Klas_AtomicReduce_reduce_f32_kernel_2(float *a, float *gr);
__global__ __launch_bounds__(1) static void
Klas_AtomicReduce_reduce_f64_kernel_3(double *a, double *gr);
...
uint32_t Klas_AtomicReduce_reduce_u32(uint32_t n, uint32_t *a)
{
    ...
    KPR_KCALL(Klas_AtomicReduce_reduce_u32_kernel_0, n, ((uint32_t) 1U),
        ((uint32_t) 0U), s, a, gr);
...
uint64_t Klas_AtomicReduce_reduce_u64(uint32_t n, uint64_t *a)
{
    ...
    cudaStream_t s = KPR_FRESH_STREAM();
    KPR_KCALL(Klas_AtomicReduce_reduce_u64_kernel_1, n, ((uint32_t) 1U),
        ((uint32_t) 0U), s, a, gr);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
...
float Klas_AtomicReduce_reduce_f32(uint32_t n, float *a)
{
    ...
    KPR_MEMCPY_H2D(gr, &r, ((uint32_t) 4U));
    cudaStream_t s = KPR_FRESH_STREAM();
    KPR_KCALL(Klas_AtomicReduce_reduce_f32_kernel_2, n, ((uint32_t) 1U),
        ((uint32_t) 0U), s, a, gr);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    KPR_MEMCPY_D2H(&r, gr, ((uint32_t) 4U));
...
double Klas_AtomicReduce_reduce_f64(uint32_t n, double *a)
{
    ...
    KPR_MEMCPY_H2D(gr, &r, ((uint32_t) 8U));
    cudaStream_t s = KPR_FRESH_STREAM();
    KPR_KCALL(Klas_AtomicReduce_reduce_f64_kernel_3, n, ((uint32_t) 1U),
        ((uint32_t) 0U), s, a, gr);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    KPR_MEMCPY_D2H(&r, gr, ((uint32_t) 8U));
