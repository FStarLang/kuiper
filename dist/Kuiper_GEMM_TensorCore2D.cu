    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 8U; i1++) {
                ...
                wmma::load_matrix_sync(__anf1,
                                       tile_for_tc_b_tiles +
                                       128U * (__anf011 * 16U) + __anf012 * 16U,
                                       128U);
            }
            uint32_t resIdxM = 0U;
            for (; resIdxM < 2U; resIdxM++) {
