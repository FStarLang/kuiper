  ...
  *accFrags =
  ...
  while (bkIdx < num_k_tiles)
  {
    ...
    for (; i2 < (size_t)1024U; i2 += (size_t)32U)
      sA[i2 / (size_t)16U * (size_t)16U + i2 % (size_t)16U] =
  ...
  *accFrags =
  ...
  while (bkIdx < num_k_tiles)
  {
    ...
    for (; i2 < (size_t)1024U; i2 += (size_t)64U)
      sA[i2 / (size_t)32U * (size_t)32U + i2 % (size_t)32U] =
  ...
  *accFrags =
  ...
  while (bkIdx < num_k_tiles)
  {
    ...
    for (; i2 < (size_t)4096U; i2 += (size_t)32U)
      sA[i2 / (size_t)64U * (size_t)64U + i2 % (size_t)64U] =
