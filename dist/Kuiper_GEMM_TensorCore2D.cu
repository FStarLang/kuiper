                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(512U % 256U == 0U);
    KPR_ASSERT(512U % 256U == 0U);
    KPR_KCALL(__hoisted_3, nblk, 32U, 2048U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_4, nblk, 32U, 4096U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_5, nblk, 32U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    uint32_t nblk = rows / 32U * (cols / 64U);
    KPR_ASSERT(512U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_6, nblk, 64U, 3072U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(512U % 256U == 0U);
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_7, nblk, 32U, 3072U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_8, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_9, nblk, 32U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_10, nblk, 64U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_11, nblk, 32U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    uint32_t nblk = rows / 32U * (cols / 128U);
    KPR_ASSERT(512U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_12, nblk, 64U, 5120U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(512U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_13, nblk, 32U, 5120U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_14, nblk, 128U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_15, nblk, 64U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_KCALL(__hoisted_16, nblk, 32U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_17, nblk, 128U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_18, nblk, 64U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_19, nblk, 32U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_GUARD(shared % 16U == 0U);
    KPR_GUARD(cols % 32U == 0U);
    uint32_t nblk = rows / 64U * (cols / 32U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(512U % 512U == 0U);
    KPR_KCALL(__hoisted_20, nblk, 64U, 3072U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_ASSERT(512U % 256U == 0U);
    KPR_KCALL(__hoisted_21, nblk, 32U, 3072U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_22, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_23, nblk, 32U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_KCALL(__hoisted_26, nblk, 128U, 4096U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_27, nblk, 64U, 4096U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_28, nblk, 64U, 4096U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_29, nblk, 32U, 4096U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_30, nblk, 128U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_31, nblk, 64U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_32, nblk, 64U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_33, nblk, 32U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_34, nblk, 128U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_35, nblk, 64U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_36, nblk, 64U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                              ...
                                                              half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_KCALL(__hoisted_37, nblk, 32U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_38, nblk, 128U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_39, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_40, nblk, 128U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_41, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_42, nblk, 32U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_43, nblk, 256U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_44, nblk, 128U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_45, nblk, 64U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_46, nblk, 128U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_47, nblk, 64U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_KCALL(__hoisted_48, nblk, 32U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_KCALL(__hoisted_49, nblk, 256U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_KCALL(__hoisted_50, nblk, 128U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_KCALL(__hoisted_51, nblk, 64U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_KCALL(__hoisted_52, nblk, 128U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_KCALL(__hoisted_53, nblk, 64U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_ASSERT(8192U % 256U == 0U);
    KPR_KCALL(__hoisted_54, nblk, 32U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_GUARD(shared % 16U == 0U);
    KPR_GUARD(cols % 32U == 0U);
    uint32_t nblk = rows / 128U * (cols / 32U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(512U % 512U == 0U);
    KPR_KCALL(__hoisted_55, nblk, 64U, 5120U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(512U % 256U == 0U);
    KPR_KCALL(__hoisted_56, nblk, 32U, 5120U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_KCALL(__hoisted_57, nblk, 128U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_58, nblk, 64U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_59, nblk, 32U, 10240U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_60, nblk, 128U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_61, nblk, 64U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_62, nblk, 32U, 20480U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_KCALL(__hoisted_63, nblk, 128U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(1024U % 1024U == 0U);
    KPR_KCALL(__hoisted_64, nblk, 128U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_65, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(1024U % 512U == 0U);
    KPR_KCALL(__hoisted_66, nblk, 64U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(1024U % 256U == 0U);
    KPR_KCALL(__hoisted_67, nblk, 32U, 6144U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_ASSERT(2048U % 2048U == 0U);
    KPR_KCALL(__hoisted_68, nblk, 256U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_69, nblk, 128U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_70, nblk, 128U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_71, nblk, 64U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_72, nblk, 64U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_73, nblk, 32U, 12288U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 2048U == 0U);
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_KCALL(__hoisted_74, nblk, 256U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_75, nblk, 128U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_76, nblk, 128U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_77, nblk, 64U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_78, nblk, 64U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                               ...
                                                               half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 256U == 0U);
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_KCALL(__hoisted_79, nblk, 32U, 24576U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 2048U == 0U);
    KPR_ASSERT(2048U % 2048U == 0U);
    KPR_KCALL(__hoisted_80, nblk, 256U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_81, nblk, 128U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 2048U == 0U);
    KPR_ASSERT(2048U % 2048U == 0U);
    KPR_KCALL(__hoisted_82, nblk, 256U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_83, nblk, 128U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_84, nblk, 64U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_ASSERT(2048U % 1024U == 0U);
    KPR_KCALL(__hoisted_85, nblk, 128U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_ASSERT(2048U % 512U == 0U);
    KPR_KCALL(__hoisted_86, nblk, 64U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_ASSERT(2048U % 256U == 0U);
    KPR_KCALL(__hoisted_87, nblk, 32U, 8192U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 4096U == 0U);
    KPR_KCALL(__hoisted_88, nblk, 512U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_KCALL(__hoisted_89, nblk, 256U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_90, nblk, 128U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_ASSERT(4096U % 2048U == 0U);
    KPR_KCALL(__hoisted_91, nblk, 256U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_92, nblk, 128U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_93, nblk, 64U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_ASSERT(4096U % 1024U == 0U);
    KPR_KCALL(__hoisted_94, nblk, 128U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_ASSERT(4096U % 512U == 0U);
    KPR_KCALL(__hoisted_95, nblk, 64U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_ASSERT(4096U % 256U == 0U);
    KPR_KCALL(__hoisted_96, nblk, 32U, 16384U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 4096U == 0U);
    KPR_KCALL(__hoisted_97, nblk, 512U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 2048U == 0U);
    KPR_ASSERT(8192U % 2048U == 0U);
    KPR_KCALL(__hoisted_98, nblk, 256U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_KCALL(__hoisted_99, nblk, 128U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 2048U == 0U);
    KPR_ASSERT(8192U % 2048U == 0U);
    KPR_KCALL(__hoisted_100, nblk, 256U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_KCALL(__hoisted_101, nblk, 128U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_KCALL(__hoisted_102, nblk, 64U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_ASSERT(8192U % 1024U == 0U);
    KPR_KCALL(__hoisted_103, nblk, 128U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_ASSERT(8192U % 512U == 0U);
    KPR_KCALL(__hoisted_104, nblk, 64U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                                                ...
                                                                half_t *gC)
{
    ...
    KPR_ASSERT(8192U % 256U == 0U);
    KPR_ASSERT(8192U % 256U == 0U);
    KPR_KCALL(__hoisted_105, nblk, 32U, 32768U, shared, cols, gA, gB, gC);
    MUST(cudaDeviceSynchronize());
}
