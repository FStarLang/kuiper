...
static void __hoisted_0(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 16, 16, 16), 16U));
  uint32_t fi = 0U;
  for (; fi < 16U; fi += 1U)
  ...
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; i2 < 1024U; i2 += 256U)
    {
      ...
      uint32_t row = i2 / 16U;
      uint32_t col = i2 % 16U;
      vec_memcpy(local, tileA + shared * (mrow * 64U) + __anf01 * 16U + shared * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; i < 1024U; i += 256U)
    {
      ...
      uint32_t row = i / 64U;
      uint32_t col = i % 64U;
      vec_memcpy(local, tileB + cols * (__anf01 * 16U) + mcol * 64U + cols * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; dotIdx < 1U; dotIdx += 1U)
    {
      ...
      for (; i0 < 4U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            16U * (threadIdx.x / 32U / 1U * 64U) + __anf04 * 16U + 16U * (i0 * 16U)),
          16U);
      }
      ...
      for (; i1 < 4U; i1 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 64U * (__anf05 * 16U) + 0U * 64U + i1 * 16U),
          64U);
      }
      uint32_t resIdxM = 0U;
...
)
{
  ...
  KPR_KCALL(__hoisted_0, rows / 64U * (cols / 64U), 32U, 4096U, shared, cols, gA, gB, gC);
...
static void __hoisted_1(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 32, 8, 16), 2U));
  uint32_t fi = 0U;
  for (; fi < 2U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; i2 < 1024U; i2 += 512U)
    {
      ...
      uint32_t row = i2 / 32U;
      uint32_t col = i2 % 32U;
      vec_memcpy(local, tileA + shared * (mrow * 32U) + __anf01 * 32U + shared * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; i < 1024U; i += 512U)
    {
      ...
      uint32_t row = i / 32U;
      uint32_t col = i % 32U;
      vec_memcpy(local, tileB + cols * (__anf01 * 32U) + mcol * 32U + cols * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; dotIdx < 2U; dotIdx += 1U)
    {
      ...
      for (; i0 < 1U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            32U * (threadIdx.x / 32U / 2U * 32U) + __anf04 * 16U + 32U * (i0 * 32U)),
          32U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 2U; i1 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles,
            32U * (__anf05 * 16U) + threadIdx.x / 32U % 2U * 16U + i1 * 8U),
          32U);
      }
      uint32_t resIdxM = 0U;
...
)
{
  ...
  KPR_KCALL(__hoisted_1, rows / 32U * (cols / 32U), 64U, 4096U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_2(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 8, 32, 16), 2U));
  uint32_t fi = 0U;
  for (; fi < 2U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 2U; dotIdx += 1U)
    {
      ...
      for (; i0 < 2U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            32U * (threadIdx.x / 32U / 1U * 16U) + __anf04 * 16U + 32U * (i0 * 8U)),
          32U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 1U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 32U * (__anf05 * 16U) + 0U * 32U + i1 * 32U),
          32U);
      }
      uint32_t resIdxM = 0U;
...
)
{
  ...
  KPR_GUARD(shared % 32U == 0U);
  KPR_GUARD(cols % 32U == 0U);
  KPR_KCALL(__hoisted_2, rows / 32U * (cols / 32U), 64U, 4096U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_3(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 32, 8, 16), 1U));
  uint32_t fi = 0U;
  for (; fi < 1U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; i2 < 512U; i2 += 256U)
    {
      ...
      uint32_t row = i2 / 16U;
      uint32_t col = i2 % 16U;
      vec_memcpy(local, tileA + shared * (mrow * 32U) + __anf01 * 16U + shared * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
        sA[row * 16U + col + k] = local[k];
    }
    ...
    for (; i < 128U; i += 256U)
    {
      ...
      uint32_t row = i / 8U;
      uint32_t col = i % 8U;
      vec_memcpy(local, tileB + cols * (__anf01 * 16U) + mcol * 8U + cols * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; dotIdx < 1U; dotIdx += 1U)
    {
      ...
      for (; i0 < 1U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            16U * (threadIdx.x / 32U / 1U * 32U) + __anf04 * 16U + 16U * (i0 * 32U)),
          16U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 1U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 8U * (__anf05 * 16U) + 0U * 8U + i1 * 8U),
          8U);
      }
      uint32_t resIdxM = 0U;
      for (; resIdxM < 1U; resIdxM += 1U)
...
static void __hoisted_4(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 8, 32, 16), 1U));
  uint32_t fi = 0U;
  for (; fi < 1U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 2U; dotIdx += 1U)
    {
      ...
      for (; i0 < 1U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            32U * (threadIdx.x / 32U / 1U * 8U) + __anf04 * 16U + 32U * (i0 * 8U)),
          32U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
...
static void __hoisted_5(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 16, 16, 16), 1U));
  uint32_t fi = 0U;
  for (; fi < 1U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; i2 < 256U; i2 += 256U)
    {
      ...
      uint32_t row = i2 / 16U;
      uint32_t col = i2 % 16U;
      vec_memcpy(local, tileA + shared * (mrow * 16U) + __anf01 * 16U + shared * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
        sA[row * 16U + col + k] = local[k];
    }
    ...
    for (; i < 256U; i += 256U)
    {
      ...
      uint32_t row = i / 16U;
      uint32_t col = i % 16U;
      vec_memcpy(local, tileB + cols * (__anf01 * 16U) + mcol * 16U + cols * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; dotIdx < 1U; dotIdx += 1U)
    {
      ...
      for (; i0 < 1U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            16U * (threadIdx.x / 32U / 1U * 16U) + __anf04 * 16U + 16U * (i0 * 16U)),
          16U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 1U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 16U * (__anf05 * 16U) + 0U * 16U + i1 * 16U),
          16U);
      }
      uint32_t resIdxM = 0U;
      for (; resIdxM < 1U; resIdxM += 1U)
...
)
{
  ...
  KPR_KCALL(__hoisted_5, rows / 16U * (cols / 16U), 32U, 1024U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_6(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; i2 < 4096U; i2 += 256U)
    {
      ...
      uint32_t row = i2 / 64U;
      uint32_t col = i2 % 64U;
      vec_memcpy(local, tileA + shared * (mrow * 64U) + __anf01 * 64U + shared * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
    ...
    for (; i < 4096U; i += 256U)
    {
      ...
      uint32_t row = i / 64U;
      uint32_t col = i % 64U;
      vec_memcpy(local, tileB + cols * (__anf01 * 64U) + mcol * 64U + cols * row + col);
      uint32_t k = 0U;
      for (; k < 8U; k += 1U)
        sB[row * 64U + col + k] = local[k];
    }
    ...
    for (; dotIdx < 4U; dotIdx += 1U)
    {
      ...
      for (; i0 < 4U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            64U * (threadIdx.x / 32U / 1U * 64U) + __anf04 * 16U + 64U * (i0 * 16U)),
          64U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
...
)
{
  ...
  KPR_GUARD(cols % 64U == 0U);
  KPR_KCALL(__hoisted_6, rows / 64U * (cols / 64U), 32U, 16384U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_7(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 32, 8, 16), 16U));
  uint32_t fi = 0U;
  for (; fi < 16U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 4U; dotIdx += 1U)
    {
      ...
      for (; i0 < 2U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            64U * (threadIdx.x / 32U / 1U * 64U) + __anf04 * 16U + 64U * (i0 * 32U)),
          64U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 8U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 64U * (__anf05 * 16U) + 0U * 64U + i1 * 8U),
          64U);
      }
      uint32_t resIdxM = 0U;
      for (; resIdxM < 2U; resIdxM += 1U)
...
)
{
  ...
  KPR_GUARD(shared % 64U == 0U);
  KPR_GUARD(cols % 64U == 0U);
  KPR_KCALL(__hoisted_7, rows / 64U * (cols / 64U), 32U, 16384U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_8(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 8, 32, 16), 16U));
  uint32_t fi = 0U;
  for (; fi < 16U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 4U; dotIdx += 1U)
    {
      ...
      for (; i0 < 8U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            64U * (threadIdx.x / 32U / 1U * 64U) + __anf04 * 16U + 64U * (i0 * 8U)),
          64U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 2U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 64U * (__anf05 * 16U) + 0U * 64U + i1 * 32U),
          64U);
      }
      uint32_t resIdxM = 0U;
...
)
{
  ...
  KPR_GUARD(shared % 64U == 0U);
  KPR_GUARD(cols % 64U == 0U);
  KPR_KCALL(__hoisted_8, rows / 64U * (cols / 64U), 32U, 16384U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_9(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, half_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(half, wmma::accumulator, 16, 16, 16), 4U));
  uint32_t fi = 0U;
  for (; fi < 4U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 2U; dotIdx += 1U)
    {
      ...
      for (; i0 < 2U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            32U * (threadIdx.x / 32U / 1U * 32U) + __anf04 * 16U + 32U * (i0 * 16U)),
          32U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 2U; i1 += 1U)
      {
        auto& __anf1 = bFrags[i1];
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles, 32U * (__anf05 * 16U) + 0U * 32U + i1 * 16U),
          32U);
      }
      uint32_t resIdxM = 0U;
      for (; resIdxM < 2U; resIdxM += 1U)
...
)
{
  ...
  KPR_GUARD(shared % 32U == 0U);
  KPR_GUARD(cols % 32U == 0U);
  KPR_KCALL(__hoisted_9, rows / 32U * (cols / 32U), 32U, 4096U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
  ...
  for (; bkIdx < num_k_tiles; bkIdx += 1U)
  {
    ...
    for (; dotIdx < 4U; dotIdx += 1U)
    {
      ...
      for (; i0 < 2U; i0 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_a_tiles,
            64U * (threadIdx.x / 32U / 2U * 32U) + __anf04 * 16U + 64U * (i0 * 16U)),
          64U);
      }
      uint32_t __anf05 = dotIdx;
      half_t *tile_for_tc_b_tiles = sB;
      ...
      for (; i1 < 2U; i1 += 1U)
      {
        ...
        wmma::load_matrix_sync(__anf1,
          kpr_offset(tile_for_tc_b_tiles,
            64U * (__anf05 * 16U) + threadIdx.x / 32U % 2U * 32U + i1 * 16U),
          64U);
      }
      uint32_t resIdxM = 0U;
      for (; resIdxM < 2U; resIdxM += 1U)
...
)
{
  ...
  KPR_GUARD(shared % 64U == 0U);
  KPR_GUARD(cols % 64U == 0U);
  KPR_KCALL(__hoisted_10, rows / 64U * (cols / 64U), 128U, 16384U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
...
static void __hoisted_11(uint32_t shared, uint32_t cols, half_t *gA, half_t *gB, float_t *gC)
{
  ...
  auto&
  accFrags =
    KPR_INIT(KPR_ARRAY_FRAGMENT_TYPE(KPR_FRAGMENT_TYPE_C(float, wmma::accumulator, 16, 16, 16), 4U));
  uint32_t fi = 0U;
  for (; fi < 4U; fi += 1U)
    wmma::fill_fragment(accFrags[fi], 0.0f);
  uint32_t bkIdx = 0U;
...
)
{
  ...
  KPR_GUARD(shared % 32U == 0U);
  KPR_GUARD(cols % 32U == 0U);
  KPR_KCALL(__hoisted_11, rows / 32U * (cols / 32U), 32U, 4096U, shared, cols, gA, gB, gC);
  cudaDeviceSynchronize();
}
