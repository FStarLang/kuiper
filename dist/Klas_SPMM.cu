...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 128U + (cols % 128U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 128U + (cols % 128U != 0U ? 1U : 0U)) * 128U;
                   ...
                   uint32_t *row_indices, uint32_t *gB, uint32_t *gC)
{
    ...
    KPR_KCALL(__hoisted_0, rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)),
...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 16U + (cols % 16U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 16U + (cols % 16U != 0U ? 1U : 0U)) * 16U;
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_1, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_2, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_3, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_4, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_5, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_6, rows * (cols / 16U + (cols % 16U != 0U ? 1U : 0U)),
...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 32U + (cols % 32U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 32U + (cols % 32U != 0U ? 1U : 0U)) * 32U;
    float *elems_tile = (float *)KPR_SHMEM_AT(0U);
    uint32_t *col_ind_tile = (uint32_t *) KPR_SHMEM_AT(64U);
    uint32_t ri = gA.row_off[m_idx];
    uint32_t re = gA.row_off[m_idx + 1U];
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_7, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_8, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_9, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_10, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_11, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_12, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_13, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              32U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_14, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_15, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_16, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
              16U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_17, rows * (cols / 32U + (cols % 32U != 0U ? 1U : 0U)),
...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 64U + (cols % 64U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 64U + (cols % 64U != 0U ? 1U : 0U)) * 64U;
    float *elems_tile = (float *)KPR_SHMEM_AT(0U);
    uint32_t *col_ind_tile = (uint32_t *) KPR_SHMEM_AT(64U);
    uint32_t ri = gA.row_off[m_idx];
    uint32_t re = gA.row_off[m_idx + 1U];
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_18, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_19, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_20, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              32U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_21, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_22, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              32U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_23, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_24, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_25, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              32U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_26, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_27, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_28, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              32U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_29, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_30, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              16U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_31, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
              32U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_32, rows * (cols / 64U + (cols % 64U != 0U ? 1U : 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_33,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 128U,
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_34,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_35,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_36,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_37,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_38,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_39,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_40,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 32U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_41,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_42,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 128U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_43,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_44,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 32U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_45,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 64U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_46,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 128U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_47,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 16U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_48,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 32U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_49,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 64U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_50,
              rows * (cols / 128U + (cols % 128U != 0U ? 1U : 0U)), 128U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 256U + (cols % 256U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 256U + (cols % 256U != 0U ? 1U : 0U)) * 256U;
    float *elems_tile = (float *)KPR_SHMEM_AT(0U);
    uint32_t *col_ind_tile = (uint32_t *) KPR_SHMEM_AT(64U);
    uint32_t ri = gA.row_off[m_idx];
    uint32_t re = gA.row_off[m_idx + 1U];
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_51,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 128U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_52,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_53,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_54,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_55,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_56,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_57,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_58,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 32U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_59,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_60,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 128U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_61,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_62,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 32U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_63,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 64U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_64,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 128U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_65,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 256U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_66,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 16U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_67,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 32U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_68,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 64U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_69,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 128U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_70,
              rows * (cols / 256U + (cols % 256U != 0U ? 1U : 0U)), 256U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
...
{
    uint32_t m_idx =
        row_indices[blockIdx.x / (cols / 512U + (cols % 512U != 0U ? 1U : 0U))];
    uint32_t n_idx =
        blockIdx.x % (cols / 512U + (cols % 512U != 0U ? 1U : 0U)) * 512U;
    float *elems_tile = (float *)KPR_SHMEM_AT(0U);
    uint32_t *col_ind_tile = (uint32_t *) KPR_SHMEM_AT(64U);
    uint32_t ri = gA.row_off[m_idx];
    uint32_t re = gA.row_off[m_idx + 1U];
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_71,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 128U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_72,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_73,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_74,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_75,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_76,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_77,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_78,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 32U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_79,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_80,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 128U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_81,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_82,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 32U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_83,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 64U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_84,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 128U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_85,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 256U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_86,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 16U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_87,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 32U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_88,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 64U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_89,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 128U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_90,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 256U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_91,
              rows * (cols / 512U + (cols % 512U != 0U ? 1U : 0U)), 512U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
