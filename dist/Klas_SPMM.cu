                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_1, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_7, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_18, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
