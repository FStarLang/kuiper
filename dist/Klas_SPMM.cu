                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_2, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_2, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_3, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_3, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_4, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_4, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_5, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_5, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_6, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_7, rows * (cols / 16U + (uint32_t) (cols % 16U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_8, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_8, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_9, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_10, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_10, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_11, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_12, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_12, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_13, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_14, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_14, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_15, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_16, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_17, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
              16U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(4096U);
    MUST(cudaFuncSetAttribute
         (__hoisted_18, cudaFuncAttributeMaxDynamicSharedMemorySize, 4096U));
    KPR_KCALL(__hoisted_18, rows * (cols / 32U + (uint32_t) (cols % 32U != 0U)),
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_19, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_19, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 128U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_20, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_21, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_21, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              32U, 256U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_22, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_23, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              32U, 512U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                              ...
                              uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_24, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_24, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_25, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_26, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              32U, 1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_27, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_27, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_28, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_29, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              32U, 2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_30, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_31, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              16U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_32, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
              32U, 4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(4096U);
    MUST(cudaFuncSetAttribute
         (__hoisted_33, cudaFuncAttributeMaxDynamicSharedMemorySize, 4096U));
    KPR_KCALL(__hoisted_33, rows * (cols / 64U + (uint32_t) (cols % 64U != 0U)),
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_34, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_34,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 16U, 128U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_35,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_36, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_36,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_38,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_39, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_39,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_42,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_43, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_43,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 128U,
              1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_46,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 64U, 2048U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(2048U);
    MUST(cudaFuncSetAttribute
         (__hoisted_47, cudaFuncAttributeMaxDynamicSharedMemorySize, 2048U));
    KPR_KCALL(__hoisted_47,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 128U,
              2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_50,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 64U, 4096U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(4096U);
    MUST(cudaFuncSetAttribute
         (__hoisted_51, cudaFuncAttributeMaxDynamicSharedMemorySize, 4096U));
    KPR_KCALL(__hoisted_51,
              rows * (cols / 128U + (uint32_t) (cols % 128U != 0U)), 128U,
              4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_52, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_52,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 16U, 128U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_53,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_54, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_54,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_56,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_57, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_57,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_60,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_61, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_61,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 128U,
              1024U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_66,
              rows * (cols / 256U + (uint32_t) (cols % 256U != 0U)), 256U,
              2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(128U);
    MUST(cudaFuncSetAttribute
         (__hoisted_72, cudaFuncAttributeMaxDynamicSharedMemorySize, 128U));
    KPR_KCALL(__hoisted_72,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 16U, 128U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_73,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 16U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(256U);
    MUST(cudaFuncSetAttribute
         (__hoisted_74, cudaFuncAttributeMaxDynamicSharedMemorySize, 256U));
    KPR_KCALL(__hoisted_74,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 32U, 256U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_76,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 32U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                               ...
                               uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(512U);
    MUST(cudaFuncSetAttribute
         (__hoisted_77, cudaFuncAttributeMaxDynamicSharedMemorySize, 512U));
    KPR_KCALL(__hoisted_77,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 64U, 512U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                ...
                                uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_KCALL(__hoisted_80,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 64U, 1024U,
              cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(1024U);
    MUST(cudaFuncSetAttribute
         (__hoisted_81, cudaFuncAttributeMaxDynamicSharedMemorySize, 1024U));
    KPR_KCALL(__hoisted_81,
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(2048U);
    MUST(cudaFuncSetAttribute
         (__hoisted_86, cudaFuncAttributeMaxDynamicSharedMemorySize, 2048U));
    KPR_KCALL(__hoisted_86,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 256U,
              2048U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
                                 ...
                                 uint32_t *row_indices, float *gB, float *gC)
{
    ...
    KPR_SHMEM_FITS(4096U);
    MUST(cudaFuncSetAttribute
         (__hoisted_92, cudaFuncAttributeMaxDynamicSharedMemorySize, 4096U));
    KPR_KCALL(__hoisted_92,
              rows * (cols / 512U + (uint32_t) (cols % 512U != 0U)), 512U,
              4096U, cols, gA, row_indices, gB, gC);
    MUST(cudaDeviceSynchronize());
}
