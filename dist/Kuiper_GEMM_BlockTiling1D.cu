...
)
{
  ...
  {
    __syncthreads();
    size_t __anf110269 = bk;
    size_t i0 = (size_t)0U;
    while (i0 < (size_t)32U)
    {
      size_t vi = i0;
      ar[vi * (size_t)32U + threadIdx.x] =
        gA4[(mrow * (size_t)32U + vi) * shared + __anf110269 * (size_t)32U + threadIdx.x];
      ar[(size_t)1024U + vi * (size_t)32U + threadIdx.x] =
        gB4[(__anf110269 * (size_t)32U + vi) * cols + mcol * (size_t)32U + threadIdx.x];
      i0 = vi + (size_t)1U;
    }
    __syncthreads();
    size_t sk = (size_t)0U;
    ...
    {
      size_t i = (size_t)0U;
      float_t v2 = ar[(size_t)1024U + sk * (size_t)32U + threadIdx.x];
      while (i < (size_t)32U)
      {
        sums[i] += ar[i * (size_t)32U + sk] * v2;
        i += (size_t)1U;
      }
      sk += (size_t)1U;
    }
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      double_t v2 = ar[(size_t)1024U + sk * (size_t)32U + threadIdx.x];
      while (i < (size_t)32U)
      {
        sums[i] += ar[i * (size_t)32U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      uint32_t v2 = ar[(size_t)1024U + sk * (size_t)32U + threadIdx.x];
      while (i < (size_t)32U)
      {
        sums[i] += ar[i * (size_t)32U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      uint64_t v2 = ar[(size_t)1024U + sk * (size_t)32U + threadIdx.x];
      while (i < (size_t)32U)
      {
        sums[i] += ar[i * (size_t)32U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    while (i0 < (size_t)32U)
    {
      size_t vi = i0;
      ar[vi * (size_t)32U + threadIdx.x] =
        gA4[(__anf110269 * (size_t)32U + threadIdx.x) * rows + mrow * (size_t)32U + vi];
      ar[(size_t)1024U + vi * (size_t)32U + threadIdx.x] =
        gB4[(mcol * (size_t)32U + threadIdx.x) * shared + __anf110269 * (size_t)32U + vi];
      i0 = vi + (size_t)1U;
    }
    __syncthreads();
    size_t sk = (size_t)0U;
  ...
  while (bk < mshared)
  {
    ...
    while (i0 < (size_t)16U)
    {
      ...
      ar[vi * (size_t)16U + threadIdx.x] =
        gA4[(mrow * (size_t)16U + vi) * shared + __anf110269 * (size_t)16U + threadIdx.x];
      ar[(size_t)256U + vi * (size_t)16U + threadIdx.x] =
        gB4[(__anf110269 * (size_t)16U + vi) * cols + mcol * (size_t)16U + threadIdx.x];
      i0 = vi + (size_t)1U;
    }
    __syncthreads();
    size_t sk = (size_t)0U;
    ...
    {
      size_t i = (size_t)0U;
      float_t v2 = ar[(size_t)256U + sk * (size_t)16U + threadIdx.x];
      while (i < (size_t)16U)
      {
        sums[i] += ar[i * (size_t)16U + sk] * v2;
        i += (size_t)1U;
      }
      sk += (size_t)1U;
    }
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      double_t v2 = ar[(size_t)256U + sk * (size_t)16U + threadIdx.x];
      while (i < (size_t)16U)
      {
        sums[i] += ar[i * (size_t)16U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      uint32_t v2 = ar[(size_t)256U + sk * (size_t)16U + threadIdx.x];
      while (i < (size_t)16U)
      {
        sums[i] += ar[i * (size_t)16U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    {
      size_t i = (size_t)0U;
      uint64_t v2 = ar[(size_t)256U + sk * (size_t)16U + threadIdx.x];
      while (i < (size_t)16U)
      {
        sums[i] += ar[i * (size_t)16U + sk] * v2;
        i += (size_t)1U;
...
)
{
  ...
  while (bk < mshared)
  {
    ...
    while (i0 < (size_t)16U)
    {
      size_t vi = i0;
      ar[vi * (size_t)16U + threadIdx.x] =
        gA4[(__anf110269 * (size_t)16U + threadIdx.x) * rows + mrow * (size_t)16U + vi];
      ar[(size_t)256U + vi * (size_t)16U + threadIdx.x] =
        gB4[(mcol * (size_t)16U + threadIdx.x) * shared + __anf110269 * (size_t)16U + vi];
      i0 = vi + (size_t)1U;
    }
    __syncthreads();
    size_t sk = (size_t)0U;
