...
Kuiper_Example_ArrayReversal_reverse_u64_kernel_0(uint32_t size, uint64_t *a);
...
void Kuiper_Example_ArrayReversal_reverse_u64(uint32_t size, uint64_t *a)
{
    ...
    KPR_KCALL(Kuiper_Example_ArrayReversal_reverse_u64_kernel_0, (size / 2),
        ((uint32_t) 1U), ((uint32_t) 0U), s, size, a);
