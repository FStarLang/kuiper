...
__hoisted_g_gemm_f16_f16_64x64x16_16x16x16_2x2_0(
    uint32_t shared, uint32_t cols, half *gA, half *gB, half *gC)
{
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; i < 1024U; i += 1024U) {
            ...
            vec_memcpy(local,
                tileB + (cols * __anf05 * 16U + mcol * 64U + cols * row + col));
            uint32_t k = 0U;
            for (; k < 8U; k++)
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 2U; i1++)
                wmma::load_matrix_sync(bFrags[i1],
                    tile_for_tc_b_tiles +
                        (64U * __anf016 * 16U + threadIdx.x / 32U % 2U * 32U +
                            i1 * 16U),
                    64U);
            uint32_t resIdxM = 0U;
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x16_16x16x16_2x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x16_16x16x16_2x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
...
void Klas_GEMM_TensorCore2D_g_gemm_bf16_f32_64x64x16_16x16x16_2x2(uint32_t rows,
    uint32_t shared, uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB,
    float *gC)
{
    KPR_GUARD(rows % 64U == 0U);
    KPR_GUARD(shared % 16U == 0U);
    ...
    uint32_t shared, uint32_t cols, half *gA, half *gB, half *gC)
{
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 4U; i1++)
                wmma::load_matrix_sync(bFrags[i1],
                    tile_for_tc_b_tiles + (64U * __anf016 * 16U + i1 * 16U),
                    64U);
            uint32_t resIdxM = 0U;
            for (; resIdxM < 2U; resIdxM++) {
                uint32_t resIdxN = 0U;
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x16_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x16_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x16_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x16_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x16_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x16_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
    ...
    uint32_t shared, uint32_t cols, half *gA, half *gB, half *gC)
{
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; i < 2048U; i += 1024U) {
            ...
            uint32_t col = (i + threadIdx.x * 8U) % 64U;
            vec_memcpy(local,
                tileB + (cols * __anf05 * 32U + mcol * 64U + cols * row + col));
            uint32_t k = 0U;
            for (; k < 8U; k++)
                sB[row * 64U + col + k] = local[k];
        }
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x32_16x16x16_2x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x32_16x16x16_2x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x32_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x32_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x32_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x32_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x32_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x32_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
    ...
    uint32_t shared, uint32_t cols, half *gA, half *gB, half *gC)
{
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; i < 4096U; i += 1024U) {
            ...
            uint32_t col = (i + threadIdx.x * 8U) % 64U;
            vec_memcpy(local,
                tileB + (cols * __anf05 * 64U + mcol * 64U + cols * row + col));
            uint32_t k = 0U;
            for (; k < 8U; k++)
                sB[row * 64U + col + k] = local[k];
        }
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x64_16x16x16_2x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x64_16x16x16_2x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x64_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x64_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x64_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x64_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x64x64_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x64x64_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 4U; i1++)
                wmma::load_matrix_sync(bFrags[i1],
                    tile_for_tc_b_tiles +
                        (128U * __anf016 * 16U + threadIdx.x / 32U % 2U * 64U +
                            i1 * 16U),
                    128U);
            uint32_t resIdxM = 0U;
            for (; resIdxM < 2U; resIdxM++) {
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x16_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x16_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
    ...
    uint32_t shared, uint32_t cols, half *gA, half *gB, half *gC)
{
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 8U; i1++)
                wmma::load_matrix_sync(bFrags[i1],
                    tile_for_tc_b_tiles + (128U * __anf016 * 16U + i1 * 16U),
                    128U);
            uint32_t resIdxM = 0U;
            for (; resIdxM < 2U; resIdxM++) {
                uint32_t resIdxN = 0U;
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x16_16x16x16_2x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x16_16x16x16_2x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
    ...
    for (; bkIdx < num_k_tiles; bkIdx++) {
        ...
        for (; dotIdx < 1U; dotIdx++) {
            ...
            for (; i1 < 2U; i1++)
                wmma::load_matrix_sync(bFrags[i1],
                    tile_for_tc_b_tiles +
                        (128U * __anf016 * 16U + threadIdx.x / 32U % 4U * 32U +
                            i1 * 16U),
                    128U);
            uint32_t resIdxM = 0U;
            for (; resIdxM < 4U; resIdxM++) {
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x16_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x16_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x16_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x16_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x16_16x16x16_4x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x16_16x16x16_4x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(2048U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_2x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_2x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_2x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_2x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x32_16x16x16_4x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x32_16x16x16_4x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(4096U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_2x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_2x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_2x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_2x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_2x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_2x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_4x2
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_4x2_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_4x4
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_4x4_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_64x128x64_16x16x16_4x8
*/
static void
__hoisted_g_gemm_bf16_f32_64x128x64_16x16x16_4x8_0(uint32_t shared,
    uint32_t cols, __nv_bfloat16 *gA, __nv_bfloat16 *gB, float *gC)
{
    __nv_bfloat16 *sA = (__nv_bfloat16 *) KPR_SHMEM_AT(0U);
    __nv_bfloat16 *sB = (__nv_bfloat16 *) KPR_SHMEM_AT(8192U);
...
__global__
/**
  hoisted when extracting g_gemm_bf16_f32_128x64