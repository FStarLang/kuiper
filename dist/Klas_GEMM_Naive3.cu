...
Klas_GEMM_Naive3_g_matmul_bf16_rrr_kernel_0(uint32_t m, uint32_t n, uint32_t k,
    custard_bf16 *gA, custard_bf16 *gB, custard_bf16 *gC);
__global__ __launch_bounds__(1024) static void
Klas_GEMM_Naive3_g_matmul_f32_rrr_kernel_1(
    uint32_t m, uint32_t n, uint32_t k, float *gA, float *gB, float *gC);
__global__ __launch_bounds__(1024) static void
Klas_GEMM_Naive3_g_matmul_f64_rrr_kernel_2(
    uint32_t m, uint32_t n, uint32_t k, double *gA, double *gB, double *gC);
__global__ __launch_bounds__(1024) static void
Klas_GEMM_Naive3_g_matmul_bf16_ccc_kernel_3(uint32_t m, uint32_t n,
    custard_bf16 *gA, uint32_t k, custard_bf16 *gB, custard_bf16 *gC);
__global__ __launch_bounds__(1024) static void
Klas_GEMM_Naive3_g_matmul_f32_ccc_kernel_4(
    uint32_t m, uint32_t n, float *gA, uint32_t k, float *gB, float *gC);
__global__ __launch_bounds__(1024) static void
Klas_GEMM_Naive3_g_matmul_f64_ccc_kernel_5(
    ...
    custard_bf16 *gA, custard_bf16 *gB, custard_bf16 *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_bf16_rrr_kernel_0,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        k, gA, gB, gC);
    ...
    uint32_t m, uint32_t n, uint32_t k, float *gA, float *gB, float *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_f32_rrr_kernel_1,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        k, gA, gB, gC);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    ...
    uint32_t m, uint32_t n, uint32_t k, double *gA, double *gB, double *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_f64_rrr_kernel_2,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        k, gA, gB, gC);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    ...
    custard_bf16 *gA, custard_bf16 *gB, custard_bf16 *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_bf16_ccc_kernel_3,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        gA, k, gB, gC);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    ...
    uint32_t m, uint32_t n, uint32_t k, float *gA, float *gB, float *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_f32_ccc_kernel_4,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        gA, k, gB, gC);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
    ...
    uint32_t m, uint32_t n, uint32_t k, double *gA, double *gB, double *gC)
{
    ...
    if (((m * n) % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Klas_GEMM_Naive3_g_matmul_f64_ccc_kernel_5,
        (((m * n) / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, m, n,
        gA, k, gB, gC);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
