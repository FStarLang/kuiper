...
__global__ __launch_bounds__(1024) static void kuiper_kernel_0(uint32_t m,
    uint32_t n, uint32_t k, custard_bf16 *gA, custard_bf16 *gB,
    custard_bf16 *gC);
__global__ __launch_bounds__(1024) static void kuiper_kernel_1(
    uint32_t m, uint32_t n, uint32_t k, float *gA, float *gB, float *gC);
__global__ __launch_bounds__(1024) static void kuiper_kernel_2(
...
__global__ __launch_bounds__(1024) static void kuiper_kernel_3(uint32_t m,
    uint32_t n, custard_bf16 *gA, uint32_t k, custard_bf16 *gB,
    custard_bf16 *gC);
