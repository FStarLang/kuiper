...
Kuiper_Example_OnlineSoftmax__test_kernel_0(uint32_t len, float *a, float *b);
__global__ __launch_bounds__(1024) static void
Kuiper_Example_OnlineSoftmax__testh_kernel_1(
...
void Kuiper_Example_OnlineSoftmax__test(uint32_t len, float *a, float *b)
{
    ...
    if ((len % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Kuiper_Example_OnlineSoftmax__test_kernel_0,
        ((len / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, len, a,
        b);
    ...
    uint32_t len, custard_f16 *a, custard_f16 *b)
{
    ...
    if ((len % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(Kuiper_Example_OnlineSoftmax__testh_kernel_1,
        ((len / 1024) + _ct1), ((uint32_t) 1024U), ((uint32_t) 0U), s, len, a,
        b);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
