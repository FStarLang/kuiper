...
__global__ static void kuiper_kernel_0(size_t len, float *a, float *b);
__global__ static void kuiper_kernel_1(size_t len, custard_f16 *a,
                                       custard_f16 *b);
...
void Kuiper_Example_OnlineSoftmax__test(size_t len, float *a, float *b)
{
    ...
    if ((len % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(kuiper_kernel_0, ((len / 1024) + _ct1), ((size_t) 1024ULL),
              ((size_t) 0ULL), s, len, a, b);
                                         ...
                                         custard_f16 *b)
{
    ...
    if ((len % 1024) != 0)
        ...
        _ct1 = 0;
    KPR_KCALL(kuiper_kernel_1, ((len / 1024) + _ct1), ((size_t) 1024ULL),
              ((size_t) 0ULL), s, len, a, b);
    KPR_MUST_stream_sync(s);
    KPR_MUST_stream_destroy(s);
}
