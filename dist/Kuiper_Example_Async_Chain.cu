...
Kuiper_Example_Async_Chain_main_kernel_0(uint64_t *r);
__global__ __launch_bounds__(1) static void
Kuiper_Example_Async_Chain_main_kernel_1(uint64_t *r);
__global__ __launch_bounds__(1) static void
Kuiper_Example_Async_Chain_main_kernel_2(uint64_t *r);
...
uint64_t Kuiper_Example_Async_Chain_main(void)
{
    ...
    KPR_KCALL(Kuiper_Example_Async_Chain_main_kernel_0, ((uint32_t) 1U),
        ((uint32_t) 1U), ((uint32_t) 0U), s, r);
    KPR_KCALL(Kuiper_Example_Async_Chain_main_kernel_1, ((uint32_t) 1U),
        ((uint32_t) 1U), ((uint32_t) 0U), s, r);
    KPR_KCALL(Kuiper_Example_Async_Chain_main_kernel_2, ((uint32_t) 1U),
        ((uint32_t) 1U), ((uint32_t) 0U), s, r);
