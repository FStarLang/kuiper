...
__global__ __launch_bounds__(1) static void kuiper_kernel_0(uint64_t *r);
__global__ __launch_bounds__(1) static void kuiper_kernel_1(uint64_t *r);
__global__ __launch_bounds__(1) static void kuiper_kernel_2(uint64_t *r);
