...
let kpr_translate_expr : translate_expr_t = fun env e ->
  ...
  | "Kuiper.Float16.smallest", [], [] -> EConstant (Half, "HLF_MIN")
  | "Kuiper.Float16.largest",  [], [] -> EConstant (Half, "HLF_MAX")
  | "Kuiper.Float16.infinity", [], [] -> EConstant (Half, "HLF_INFINITY")
  ...
  | "Kuiper.Float32.smallest", [], [] -> EConstant (Float, "FLT_MIN")
  | "Kuiper.Float32.largest",  [], [] -> EConstant (Float, "FLT_MAX")
  | "Kuiper.Float32.infinity", [], [] -> EConstant (Float, "INFINITY")

  | "Kuiper.Float64.zero", [], [] -> EConstant (Double, "0.0")
  | "Kuiper.Float64.one",  [], [] -> EConstant (Double, "1.0")
  ...
  | "Kuiper.Float64.smallest", [], [] -> EConstant (Double, "DBL_MIN")
  | "Kuiper.Float64.largest",  [], [] -> EConstant (Double, "DBL_MAX")
  | "Kuiper.Float64.infinity", [], [] -> EConstant (Double, "INFINITY")
