...
ghost fn if_rewrite_bool (b1 b2: bool) (#_: squash (b1 == b2)) (p: slprop)
  requires if_ b1 p
  ensures  if_ b2 p
...
ghost fn if_intro_true (p: slprop)
  requires p
  ensures  if_ true p

ghost fn if_intro_false (p: slprop)
  requires emp
  ensures  if_ false p

ghost fn if_elim_true (p: slprop)
  requires if_ true p
  ensures  p

ghost fn if_elim_false (p: slprop)
