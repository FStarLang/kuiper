...
[@@coercion; Pulse.Lib.Core.pulse_unfold] unfold let sizet_to_eint (x: SZ.t)  : erased int = SZ.v x
[@@coercion; Pulse.Lib.Core.pulse_unfold] unfold let u32_to_eint   (x: U32.t) : erased int = U32.v x
[@@coercion; Pulse.Lib.Core.pulse_unfold] unfold let u64_to_eint   (x: U64.t) : erased int = U64.v x
