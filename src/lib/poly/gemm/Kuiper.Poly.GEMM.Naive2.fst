...
=
{
  ...
  block_pre  = (fun bid -> forall+ (tid : natlt blocksz). kpre  comb gA gB gC eA eB eC 1.0R bid tid);
  block_post = (fun bid -> forall+ (tid : natlt blocksz). kpost comb gA gB gC eA eB eC 1.0R bid tid);
