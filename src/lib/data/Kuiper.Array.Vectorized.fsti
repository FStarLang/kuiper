...
instance has_vec_cpy_u8 : has_vec_cpy u8 =
  Kuiper.Scalars.lem_sizeof_u8 ();
  { _chunk = 16sz; _pf = ez; }

unfold inline_for_extraction noextract
instance has_vec_cpy_u16 : has_vec_cpy u16 =
  Kuiper.Scalars.lem_sizeof_u16 ();
  { _chunk = 8sz; _pf = ez; }

unfold inline_for_extraction noextract
instance has_vec_cpy_u32 : has_vec_cpy u32 =
  Kuiper.Scalars.lem_sizeof_u32 ();
  { _chunk = 4sz; _pf = ez; }

unfold inline_for_extraction noextract
instance has_vec_cpy_u64 : has_vec_cpy u64 =
  Kuiper.Scalars.lem_sizeof_u64 ();
  { _chunk = 2sz; _pf = ez; }
...
fn array_vec_cpy
  ...
  (dst_arr : array et)
  (dst_off : SZ.t)
  (#dst_slice_i #dst_slice_j : erased nat)
  (src_arr : array et)
  (src_off : SZ.t)
  (#src_slice_i #src_slice_j : erased nat)
  (#f : perm)
  (#ss : erased (seq et))
  (#ds : erased (seq et))
