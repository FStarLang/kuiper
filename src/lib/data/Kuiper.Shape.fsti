...
inline_for_extraction noextract
[@@strict_on_arguments [3]]
val conc_le (#r : erased nat) (#d1 #d2 : shape r { shape_le d1 d2 })
...
val abs_set_at2_cons (#r : nat) (d1 d2 : shape r { shape_le d1 d2 }) (dim : natlt r)
...
inline_for_extraction noextract
[@@strict_on_arguments [3]]
val conc_set_at2 (#r : erased nat) (#d1 #d2 : shape r { shape_le d1 d2 })
...
inline_for_extraction noextract
[@@strict_on_arguments [2]]
val conc_get_at (#r : erased nat) (#d : shape r) (cd : cshape d) (dim : szlt r) (x : conc d)
...
val conc_narrow (#r : erased nat) (dim : szlt r) (#d1 #d2 : shape r)
