...
type ematrix4 (et:Type) (mrows brows mcols bcols : nat) =
  M.ematrix et
    (mrows * brows)
    (mcols * bcols)

let mkM (#et:Type) (#mrows #brows #mcols #bcols : nat)
  (f : natlt mrows -> natlt brows -> natlt mcols -> natlt bcols -> GTot et)
  : ematrix4 et mrows brows mcols bcols
  = M.mkM <| fun i j -> f (i / brows) (i % brows) (j / bcols) (j % bcols)
...
let mtranspose (#et:Type) (#mrows #brows #mcols #bcols : nat)
  (m : ematrix4 et mrows brows mcols bcols)
