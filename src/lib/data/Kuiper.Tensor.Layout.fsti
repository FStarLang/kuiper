...
[@@erasable]
noeq
type tlayout (#r : erased nat) (d : shape r) = {
...
let is_full (#r : nat) (#d : shape r) (l : tlayout d) : prop =
  is_surj l.imap.f
...
val full_layout_size (#r : nat) (#d : shape r) (l : tlayout d)
...
let tlayout_ulen (#d : shape 'r) (l : tlayout d) : GTot nat = l.ulen
let tlayout_size (#d : shape 'r) (l : tlayout d) : GTot nat = sizeof d

val size_le_ulen (#r : nat) (#d : shape r) (l : tlayout d)
...
class ctlayout (#r : erased nat) (#d : shape r) (l : tlayout d) = {
...
val ctlayout_must_fit (#r : nat) (#d : shape r) (#l : tlayout d)
  (c : ctlayout l)
  : Lemma (ensures SZ.fits (sizeof d))
          [SMTPat (has_type c (ctlayout #r #d l))]

let tensor_aview (et : Type) (#r : nat) (#d : shape r) (l : tlayout d)
...
let full_layout3 d1 d2 d3 = l : layout3 d1 d2 d3 { is_full l }
...
let full_layout4 d1 d2 d3 d4 = l : layout4 d1 d2 d3 d4 { is_full l }
