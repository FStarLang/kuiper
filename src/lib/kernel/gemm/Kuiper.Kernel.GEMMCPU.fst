...
//   (gA : gpu_matrix et (rA rows shared) { M.is_global gA })
//   (gB : gpu_matrix et (rB shared cols) { M.is_global gB })
//   (gC : gpu_matrix et (rC rows cols) { M.is_global gC })
...
//   (gA : gpu_matrix et (repA rows shared) { M.is_global gA })
//   (gB : gpu_matrix et (repB shared cols) { M.is_global gB })
//   (gC : gpu_matrix et (repC rows cols) { M.is_global gC })
//   (#ma : ematrix et rows shared)
//   (#mb : ematrix et shared cols)
//   (#mc0 : ematrix et rows cols)
