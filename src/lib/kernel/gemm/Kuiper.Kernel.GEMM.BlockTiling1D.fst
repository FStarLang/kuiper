  ...
  {
    {
      ...
      tensor_write_cell sa1 ((ci <: szlt _), ((tid <: szlt _), ())) v1;
      ambig_trade_elim ();
      ambig_trade_elim ();
...

    {
      ...
      tensor_write_cell sa2 ((ci <: szlt _), ((tid <: szlt _), ())) v2;
      ambig_trade_elim ();
      ambig_trade_elim ();
    ...
    B.barrier_state (2 * k)
{
    ...
    decreases (tile - !row)
  {
    ...
    let v1 = sums.(!row);
    let v' = comb v0 v1;
    tensor_write_cell tileC ((crow <: szlt _), ((bcol <: szlt _), ())) v';
    ...
    emp (* frame *)
{
  ...
  tensor_share_n gA ((m * n) * tile);
  tensor_share_n gB ((m * n) * tile);
