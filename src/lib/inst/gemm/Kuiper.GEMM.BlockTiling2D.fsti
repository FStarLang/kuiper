...
let size_req tile : size_req_t =
  fun rows shared cols ->
    rows * cols <= max_blocks

val matmul_f32_64x64x8_8x8_rrr_rr   : fixed_repr_matmul_cpu_ty f32 (size_req 64) RM RM RM
val matmul_f32_32x32x32_32x8_rrr_rr : fixed_repr_matmul_cpu_ty f32 (size_req 32) RM RM RM
