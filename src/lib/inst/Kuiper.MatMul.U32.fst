...
let kernel_u32 = kernel #u32 R.row_major R.row_major R.row_major

let matmul_u32 : matmul_ty u32 R.row_major R.row_major R.row_major =
  matmul kernel_u32

[@@CPrologue "__global__"]
let kernel_u32' = kernel #u32 R.col_major R.col_major R.col_major

let matmul_u32' : matmul_ty u32 R.col_major R.col_major R.col_major =
  matmul kernel_u32'

[@@CPrologue "__global__"]
let kernel_u32'' = kernel #u32 R.col_major R.col_major R.row_major
