module Kuiper.MatMulOpt.Kernel
...
open Kuiper
open Kuiper.SizeT
open Kuiper.MatMulOpt.Barrier
open Kuiper.MatMulOpt.Layout
module Impure = Kuiper.MatMulOpt.Impure
module Pure = Kuiper.MatMulOpt.Pure
