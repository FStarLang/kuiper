...
let test_expm1_f16    (x : f16)     : f16 = Kuiper.Float16.fexpm1 x
let test_log1p_f16    (x : f16)     : f16 = Kuiper.Float16.flog1p x
...
let test_expm1_f32    (x : f32)     : f32 = Kuiper.Float32.fexpm1 x
let test_log1p_f32    (x : f32)     : f32 = Kuiper.Float32.flog1p x
...
let test_expm1_f64    (x : f64)     : f64 = Kuiper.Float64.fexpm1 x
let test_log1p_f64    (x : f64)     : f64 = Kuiper.Float64.flog1p x
...
let test_expm1_bf16   (x : bf16)    : bf16 = Kuiper.BFloat16.fexpm1 x
let test_log1p_bf16   (x : bf16)    : bf16 = Kuiper.BFloat16.flog1p x
